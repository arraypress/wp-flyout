...
class FeatureList {
    ...
    /**
     * Quick render of feature list
     *
     * @param array  $items List items.
     * @param string $icon  Optional icon for all items.
     *
     * @return string Rendered HTML.
     * @since 1.0.0
     */
    public static function quick( array $items, string $icon = 'yes-alt' ): string {
        return ( new self( $items, [ 'icon' => $icon ] ) )->render();
    }
